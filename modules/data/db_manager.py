...
class DbManager():
    ...
    def get_db() -> Tuple[sqlite3.Connection, sqlite3.Cursor]:
        ...
        if DbManager.use_remote_db:  # connect to the remote db
            conn = psycopg2.connect(DbManager.db_url, sslmode='require')
...
DbManager.db_url = os.getenv("DATABASE_URL", None)
DbManager.use_remote_db = DbManager.db_url is not None
DbManager.query_from_file("data", "db", "init.sql")
